larc_lite_reduction <- function(TAG='20190529',LARCDIR="/Users/bkoester/Box Sync/LARC.FLAT/",OUTDIR="/Users/bkoester/Box Sync/LARC.WORKING/")
{
  ...
  lsi <- add.major.division(lsi)
  lsi <- add.zipcode.county.geoid(lsi)
